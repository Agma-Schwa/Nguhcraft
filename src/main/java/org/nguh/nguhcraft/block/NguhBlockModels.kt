...
object NguhBlockModels {
    ...
    val VERTICAL_SLABS = mutableListOf(
        ...
        VSlab(NguhBlocks.BLACK_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.black),
        VSlab(NguhBlocks.BLACK_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.black, false, true),
        VSlab(NguhBlocks.BLUE_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.blue),
        VSlab(NguhBlocks.BLUE_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.blue, false, true),
        VSlab(NguhBlocks.BRICK_SLAB_VERTICAL , Blocks.BRICKS),
        VSlab(NguhBlocks.BROWN_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.brown),
        VSlab(NguhBlocks.BROWN_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.brown, false, true),
        ...
        VSlab(NguhBlocks.CYAN_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.cyan),
        VSlab(NguhBlocks.CYAN_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.cyan, false, true),
        ...
        VSlab(NguhBlocks.GRAY_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.gray),
        VSlab(NguhBlocks.GRAY_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.gray, false, true),
        VSlab(NguhBlocks.GREEN_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.green),
        VSlab(NguhBlocks.GREEN_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.green, false, true),
        VSlab(NguhBlocks.JUNGLE_SLAB_VERTICAL, Blocks.JUNGLE_PLANKS, true) ,
        VSlab(NguhBlocks.LIGHT_BLUE_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.lightBlue),
        VSlab(NguhBlocks.LIGHT_BLUE_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.lightBlue, false, true),
        VSlab(NguhBlocks.LIGHT_GRAY_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.lightGray),
        VSlab(NguhBlocks.LIGHT_GRAY_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.lightGray, false, true),
        VSlab(NguhBlocks.LIME_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.lime),
        VSlab(NguhBlocks.LIME_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.lime, false, true),
        VSlab(NguhBlocks.MAGENTA_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.magenta),
        VSlab(NguhBlocks.MAGENTA_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.magenta, false, true),
        ...
        VSlab(NguhBlocks.ORANGE_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.orange),
        VSlab(NguhBlocks.ORANGE_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.orange, false, true),
        ...
        VSlab(NguhBlocks.PINK_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.pink),
        VSlab(NguhBlocks.PINK_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.pink, false, true),
        ...
        VSlab(NguhBlocks.POLISHED_SULFUR_SLAB_VERTICAL, Blocks.POLISHED_SULFUR_SLAB),
        VSlab(NguhBlocks.POLISHED_TUFF_SLAB_VERTICAL, Blocks.POLISHED_TUFF),
        VSlab(NguhBlocks.POPLAR_SLAB_VERTICAL, Blocks.POPLAR_SLAB, true),
        ...
        VSlab(NguhBlocks.PURPLE_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.purple),
        VSlab(NguhBlocks.PURPLE_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.purple, false, true),
        VSlab(NguhBlocks.PURPUR_SLAB_VERTICAL, Blocks.PURPUR_BLOCK),
        VSlab(NguhBlocks.QUARTZ_SLAB_VERTICAL, Blocks.QUARTZ_BLOCK, false, false, TextureMapping.getBlockTexture(Blocks.QUARTZ_BLOCK, "_top")),
        VSlab(NguhBlocks.RED_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.red),
        ...
        VSlab(NguhBlocks.RED_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.red, false, true),
        VSlab(NguhBlocks.SANDSTONE_SLAB_VERTICAL, Blocks.SANDSTONE),
        VSlab(NguhBlocks.SMOOTH_QUARTZ_SLAB_VERTICAL, Blocks.SMOOTH_QUARTZ, false, false , TextureMapping.getBlockTexture(Blocks.QUARTZ_BLOCK, "_bottom")) ,
        ...
        VSlab(NguhBlocks.SMOOTH_SANDSTONE_SLAB_VERTICAL, Blocks.SMOOTH_SANDSTONE, false, false , TextureMapping.getBlockTexture(Blocks.SANDSTONE, "_top")),
        ...
        VSlab(NguhBlocks.SULFUR_BRICK_SLAB_VERTICAL, Blocks.SULFUR_BRICK_SLAB),
        VSlab(NguhBlocks.SULFUR_SLAB_VERTICAL, Blocks.SULFUR_SLAB),
        VSlab(NguhBlocks.TUFF_BRICK_SLAB_VERTICAL, Blocks.TUFF_BRICKS),
        VSlab(NguhBlocks.TUFF_SLAB_VERTICAL, Blocks.TUFF),
        VSlab(NguhBlocks.VANILLA_CINNABAR_BRICK_SLAB_VERTICAL, Blocks.CINNABAR_BRICK_SLAB),
        VSlab(NguhBlocks.VANILLA_CINNABAR_SLAB_VERTICAL, Blocks.CINNABAR_SLAB),
        VSlab(NguhBlocks.VANILLA_POLISHED_CINNABAR_SLAB_VERTICAL, Blocks.POLISHED_CINNABAR_SLAB),
        ...
        VSlab(NguhBlocks.WHITE_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.white),
        VSlab(NguhBlocks.WHITE_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.white, false, true),
        VSlab(NguhBlocks.YELLOW_CONCRETE_SLAB_VERTICAL, Blocks.CONCRETE_SLAB.yellow),
        VSlab(NguhBlocks.YELLOW_WOOL_SLAB_VERTICAL, Blocks.WOOL_SLAB.yellow, false, true),
